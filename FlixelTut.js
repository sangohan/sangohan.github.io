...
PlayState.prototype = $extend(flixel.FlxState.prototype,{
	...
	,_mWalls: null
	,create: function() {
		this._map = new flixel.addons.editors.ogmo.FlxOgmoLoader("assets/data/room-001.oel");
...
var Player = function(X,Y) {
	...
	this.animation.add("lr",[4,3,5],8,false);
	this.animation.add("d",[1,0,2],8,false);
	this.animation.add("u",[7,6,8],8,false);
...
Player.prototype = $extend(flixel.FlxSprite.prototype,{
	...
	,updateMovement: function() {
		...
		if(_up || _down || _left || _right) {
			...
			flixel.util.FlxAngle.rotatePoint(this.speed,0,0,0,mA,this.velocity);
